...
public class penjual extends javax.swing.JFrame {
    ...
    protected void autonumber(){
        try{
            String Query = "Select nourut from penjual order by nourut asc";
    ...
    private void bsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bsimpanActionPerformed
        String sql = "INSERT INTO penjual VALUES(?,?,?,?,?)";
        try{
    ...
    private void bubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bubahActionPerformed
        String sql = "UPDATE penjual SET nik=?,nama=?,alamat=?,notelp=? where nourut='"+txtnourut.getText()+"'";
        try{
    ...
    private void bhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bhapusActionPerformed
        ...
        if(ok==0){
            String sql ="DELETE FROM penjual WHERE nourut='"+txtnourut.getText()+"'";
            try{
                java.sql.PreparedStatement stat = conn.prepareStatement(sql);
                stat.executeUpdate();
