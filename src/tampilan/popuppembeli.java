...
public class popuppembeli extends javax.swing.JFrame {
    public formtransaksi ft = new formtransaksi();
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        ft.nikpembeli = tabmode.getValueAt(baris, 1).toString();
        ft.namapembeli = tabmode.getValueAt(baris, 2).toString();
        ft.pembeliTerpilih();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popuppembeli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
